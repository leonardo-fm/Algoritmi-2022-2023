...
plot(report_h$k, report_h$time, pch = 15, col = report$col_index, ylab = "Normalized time", xlab = "k")
legend(x = "top", bty = "n", cex = 1, horiz = TRUE, legend = levels(report$col_index), fill = c(1, 2, 3))
legend(x = "bottomright", bty = "n", cex = 0.8, horiz = TRUE, legend = c("high", "medium", "low"), pch = c(15, 16, 17))
